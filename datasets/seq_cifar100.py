...
from datasets.utils.continual_dataset import ContinualDataset, store_loaders, store_masked_loaders
...
class SequentialCIFAR100(ContinualDataset):
    ...
    def get_normalization_transform():
        transform = transforms.Normalize((0.5071,  0.4866,  0.4409),
                                  (0.2009,  0.1984,  0.2023))
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize((0.5071,  0.4866,  0.4409),
                                  (0.2009,  0.1984,  0.2023))
        return transform
