...
class MyFashionMNIST(FashionMNIST):
    """
    Overrides the FashionMNIST dataset to adjust for grayscale images.
    """
    def __init__(self, root, train=True, transform=None,
                 target_transform=None, download=False) -> None:
        super(MyFashionMNIST, self).__init__(root, train, transform, target_transform, download)
...
class SequentialFashionMNIST(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        if self.args.validation:
            ...
            test_dataset = MyFashionMNIST(base_path() + 'FashionMNIST', train=False,
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialFashionMNIST.TRANSFORM])
        return transform
